...
import Triangle.AbstractSyntaxTrees.Var2Declaration; //AGREGADO @author Steven
...
public class TreeVisitor implements Visitor {
    ...
    public Object visitCompoundIfCommand(CompoundIfCommand ast, Object o) {
        return(createQuaternary("Compound If Command", ast.E, ast.C1, ast.EIC, ast.C2));
    }
    ...
    */
    public Object visitSingleOrCommand(SingleOrCommand ast, Object obj) {
        return(createBinary("Single Or Command", ast.E, ast.C));
    }
    /*
    AGREGADO @Steven
    */    
    ...
    */
    public Object visitRepeatForInCommand(RepeatForInCommand ast, Object obj) {
        return(createTernary("Repeat For In Command", ast.I, ast.E, ast.C));
    }
    ...
    */
    public Object visitRepeatForRangeDoCommand(RepeatForRangeDoCommand ast, Object obj) {
        return(createQuaternary("Repeat For Range Do Command", ast.I, ast.E1, ast.E2, ast.C));
    }
    ...
    */
    public Object visitRepeatForRangeUntilCommand(RepeatForRangeUntilCommand ast, Object obj) {
        return(createQuinary("Repeat For Range Until Command", ast.I, ast.E1, ast.E2, ast.E3, ast.C));
    }
    /*
    AGREGADO @Steven
    */
    public Object visitRepeatForRangeWhileCommand(RepeatForRangeWhileCommand ast, Object obj) {
        return(createQuinary("Repeat For Range While Command", ast.I, ast.E1, ast.E2, ast.E3, ast.C));
    }
    ...
    */    
    ...
    public Object visitVar2Declaration(Var2Declaration ast, Object obj) {
        return(createBinary("Variable Declaration 2nd Alternative", ast.I, ast.E));
    }
    ...
    */
    ...
    public Object visitCaseLiteral(CaseLiteral AST, Object o) {
        return (createUnary("Case Literal",AST.terminalAST));
    }

    //Agregado
    public Object visitNextCaseLiteral(NextCaseLiteral AST, Object o) {
        return (createTernary("Compoused Case Literals",AST.Case_1, AST.Case_2,AST.commandAST));
    }

    //Agregado
    public Object visitOneCaseLiteral(OneCaseLiteral AST, Object o) {
        return (createBinary("One Case Literal",AST.caseLiteralAST, AST.commandAST));
    }

    //Agregado
    public Object visitElseCase(ElseCase AST, Object o) {
        return (createUnary("Else Cases",AST.elseCaseAST));
    }

    //Agregado
    public Object visitNextCase(NextCase AST, Object o) {
        return (createBinary("Compoused Case",AST.Case_1, AST.Case_2));
    }

    //Agregado
    public Object visitMixCases(MixCases AST, Object o) {
        return (createBinary("Compoused Cases",AST.caseAST, AST.elseCaseAST));
    }

    //Agregado
    public Object visitOneCases(OneCases AST, Object o) {
        return (createUnary("Normal Cases",AST.caseAST));
    }

    //Agregado
    public Object visitProcedure(Procedure AST, Object o) {
        return(createTernary("Procedure",AST.ID ,AST.FRMPARSEQ, AST.COM));
    }

    //Agregado
    public Object visitFunction(Function AST, Object o) {
        return(createQuaternary("Function",AST.idAST ,AST.fpsAST, AST.typeDenAST, AST.expAST));
    }

    //Agregado
    public Object visitNextProcFuncs(NextProcFuncs AST, Object o) {
        return (createBinary("Next ProcFuncs", AST.procFunc1 ,AST.procFunc2));
    }
    ...
    /*
    AGREGADO @author Steven
    Este metodo se agreggó por la necesidad de crear una arbol con 5 hijos para representar los AST
